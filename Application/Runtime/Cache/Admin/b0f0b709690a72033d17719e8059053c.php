...
<head>
    ...
    <title>后台管理中心</title>  
    <link rel="stylesheet" href="/cms/Public/admin/css/pintuer.css">
    <link rel="stylesheet" href="/cms/Public/admin/css/admin.css">
    <script src="/cms/Public/jquery.min.js"></script>   
</head>
<body style="background-color:#f2f9fd;">
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="/cms/Public/admin/images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="info.html" target="right"><span class="icon-caret-right"></span>网站信息</a></li>
    <li><a href="pass.html" target="right"><span class="icon-caret-right"></span>菜单管理</a></li>
